...
type RaftClient interface {
	...
	GetState(ctx context.Context, in *raftpb.SnapshotRequest, opts ...grpc.CallOption) (*commonpb.Snapshot, error)
}
...
func (c *raftClient) GetState(ctx context.Context, in *raftpb.SnapshotRequest, opts ...grpc.CallOption) (*commonpb.Snapshot, error) {
	out := new(commonpb.Snapshot)
	err := grpc.Invoke(ctx, "/gorums.Raft/GetState", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RaftServer interface {
	...
	GetState(context.Context, *raftpb.SnapshotRequest) (*commonpb.Snapshot, error)
}
...
func _Raft_GetState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gorums.Raft/GetState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServer).GetState(ctx, req.(*raftpb.SnapshotRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptorGorums = []byte{
	...
	0x3f, 0x0f, 0x45, 0xa9, 0xd1, 0x4b, 0x46, 0x2e, 0x96, 0xa0, 0xc4, 0xb4, 0x12, 0xa1, 0x00, 0x2e,
	...
	0x08, 0xc3, 0x4c, 0x95, 0xc5, 0x21, 0x8b, 0x61, 0xae, 0x39, 0x17, 0x87, 0x7b, 0x6a, 0x49, 0x70,
	0x49, 0x62, 0x49, 0xaa, 0x90, 0x38, 0x4c, 0x53, 0x70, 0x5e, 0x62, 0x41, 0x71, 0x46, 0x7e, 0x09,
	0xcc, 0x34, 0x21, 0x3d, 0x98, 0x6f, 0xe1, 0x52, 0x4e, 0x3a, 0x17, 0x1e, 0xca, 0x31, 0xdc, 0x78,
	0x28, 0xc7, 0xf0, 0xe0, 0xa1, 0x1c, 0x63, 0xc3, 0x23, 0x39, 0xc6, 0x15, 0x8f, 0xe4, 0x18, 0x4f,
	0x3c, 0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e, 0xf1, 0xc1, 0x23, 0x39, 0xc6, 0x17, 0x8f, 0xe4, 0x18,
	0x3e, 0x3c, 0x92, 0x63, 0x9c, 0xf0, 0x58, 0x8e, 0x21, 0x89, 0x0d, 0x1c, 0x40, 0xc6, 0x80, 0x00,
	0x00, 0x00, 0xff, 0xff, 0x06, 0x9d, 0x64, 0xcb, 0xc6, 0x01, 0x00, 0x00,
}
