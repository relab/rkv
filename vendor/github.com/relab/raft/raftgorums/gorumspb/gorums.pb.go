...
type AppendEntriesReply struct {
	// the actual reply
	*raftpb.AppendEntriesCombined
	NodeIDs []uint32
	err     error
}

func (r AppendEntriesReply) String() string {
	return fmt.Sprintf("node ids: %v | answer: %v", r.NodeIDs, r.AppendEntriesCombined)
}
...
func (c *Configuration) appendEntries(ctx context.Context, a *raftpb.AppendEntriesRequest, f appendEntriesArg) (resp *AppendEntriesReply, err error) {
	...
	if c.mgr.opts.trace {
		...
		defer func() {
			ti.tr.LazyLog(&qcresult{
				ids:   resp.NodeIDs,
				reply: resp.AppendEntriesCombined,
				err:   resp.err,
			}, false)
			if resp.err != nil {
				ti.tr.SetError()
	...
	for {
		...
		case r := <-replyChan:
			...
			if resp.AppendEntriesCombined, quorum = c.qspec.AppendEntriesQF(a, replyValues); quorum {
				return resp, nil
			}
		case <-ctx.Done():
...
type QuorumSpec interface {
	...
	// quorum call method.
	AppendEntriesQF(req *raftpb.AppendEntriesRequest, replies []*raftpb.AppendEntriesResponse) (*raftpb.AppendEntriesCombined, bool)
...
var fileDescriptorGorums = []byte{
	...
	0x3f, 0x0f, 0x45, 0xa9, 0xd1, 0x25, 0x26, 0x2e, 0x96, 0xa0, 0xc4, 0xb4, 0x12, 0xa1, 0x00, 0x2e,
	...
	,
	...
	0x89, 0x0d, 0x1c, 0x13, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xad, 0x9a, 0x77, 0x76, 0x2f,
	0x02, 0x00, 0x00,
}
